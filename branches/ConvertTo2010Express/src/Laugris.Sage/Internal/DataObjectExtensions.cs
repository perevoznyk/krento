namespace System.Runtime.InteropServices.ComTypes
{
    ...
    public static class ComDataObjectExtensions
    {
        ...
        public static void SetManagedData(IDataObject dataObject, string format, object data)
        {
        ...
        public static object GetManagedData(IDataObject dataObject, string format)
        {
            FORMATETC formatETC;
            FillFormatETC(format, TYMED.TYMED_HGLOBAL, out formatETC);
