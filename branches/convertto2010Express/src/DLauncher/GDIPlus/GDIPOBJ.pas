...
uses
  ...
  procedure GDIPOBJ_Finalization;
...
begin
  ...
  // Close GDI +
  if (GdiplusTokenValid) then begin
    GdiplusShutdown(gdiplusToken);
    GdiplusTokenValid := false;
  end;
end;
...
begin
  ...
  // Initialize GDI+
  GdiplusTokenValid := (GdiplusStartup(gdiplusToken, @StartupInput, nil) = Ok);
end;

finalization
begin
  GDIPOBJ_Finalization;
end;
